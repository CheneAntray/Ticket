...
public class ExcelUtils {
	...
	public static List<String> get2003ExcelColByFile(String excelFilePath, String excelFileName, String sheetName,
			int startRow, int startCol, int endCol) throws Exception {
		Cell cell = null;
	 ...
	 */
	@SuppressWarnings("resource")
	public static List<Map<Integer, String>> get2003ExcelContextByFileSheetIndex(String excelFilePath, String excelFileName,
			Integer sheetIndex) throws Exception {
		Cell cell = null;
		HSSFSheet sheet = null;
		HSSFWorkbook wb = null;
		HSSFRow rows = null;
	 ...
	 */
	@SuppressWarnings("resource")
	public static List<Map<Integer, String>> get2007ExcelContextByFileSheetIndex(String excelFilePath, String excelFileName,
			Integer sheetIndex) throws Exception {
		Cell cell = null;
		XSSFSheet sheet = null;
		XSSFRow rows = null;
