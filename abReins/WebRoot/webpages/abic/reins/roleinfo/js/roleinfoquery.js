...
/** 查询用户URL */
var queryLoadUrl = "api/role/getRoleByPage";
/** 显示添加用户页面URL */
var showAddUrl = "abic/reins/roleinfo/html/roleinfoadd.html";
/** 显示编辑用户页面URL */
var showEditUrl = "abic/reins/roleinfo/html/roleinfoedit.html";
/** 显示查看用户页面URL */
var showViewUrl = "abic/reins/roleinfo/html/roleinfoview.html";
/** 查询TABLE的ID */
...
function queryJqgridInit() {
	var colNames = [ "角色ID", "角色名称", "创建时间", "创建者", "修改时间", "修改者" ];
	var colModel = [ {
		name : "id",
		index : "id",
		autowidth : true,
...
function queryButton_click() {
    ...
    searchData.roleName = $("#query_rolename").val();
